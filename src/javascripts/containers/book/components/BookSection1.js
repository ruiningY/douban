...
class BookSection1 extends React.Component {
    ...
    getSearchHot(props) {
        ...
        jsonp('http://m.douban.com/rexxar/api/v2/subject_collection/book_nonfiction/items?os=ios&callback=&start=0&count=8&loc_id=0&_=1509421805867', {
            param: 'callback',
        }, (err, data) => {
            //  console.log(data)
    ...
    render() {
        return ( 
            <div className = "Booksection" >
                ...
                <div className = "swiper-container book-search-hot" >
    ...
    componentDidMount() {
        this.mySwiper = new Swiper('.book-search-hot', {
            freeMode: true,
            slidesPerView: 'auto',
            freeModeSticky: true,
