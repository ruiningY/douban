...
class New_movie extends React.Component {
    ...
    getSearchHot(props){
		...
		jsonp('https://m.douban.com/rexxar/api/v2/subject_collection/movie_latest/items?os=ios&for_mobile=1&callback&start=0&count=18&loc_id=108288&_=1509524793452',{
			param:'callback',			
		},(err,data)=>{
			console.log(data)
	...
	showSearchHot(){
		return this.state.searchHot.map((item,i)=>{
			return <li className="new_content" key={i}>
    ...
    render(){
        return(
            <div className="fullheight new_movie">
